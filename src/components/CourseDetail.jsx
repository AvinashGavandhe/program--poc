...
const CourseDetail = () => {
  ...
  const handleLike = async (postId) => {
    const apiUrl = `https://learningmanagereu.adobe.com/primeapi/v2/posts/${postId}/vote?action=UP`;
    const response = await axios({
      method: "POST",
      url: apiUrl,
      data: dummyData,
  ...
  const handleDisLike = async (postId) => {
    const apiUrl = `https://learningmanagereu.adobe.com/primeapi/v2/posts/${postId}/vote?action=DOWN`;
    const response = await axios({
      method: "POST",
      url: apiUrl,
      data: dummyData,
                ...
                posts?.map((post) => {
                  return (
                    <>
                      ...
                      <button className="btn" onClick={() => handleEditPost(post?.id)}>Edit Post</button>
                      <div>
